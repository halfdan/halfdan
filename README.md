...
- [parroty/exvcr](https://github.com/parroty/exvcr) - HTTP request/response recording library for elixir, inspired by VCR. (5 days ago)
...
- [parroty/exvcr](https://github.com/parroty/exvcr) ([v0.17.0](https://github.com/parroty/exvcr/releases/tag/v0.17.0), 1 day ago) - HTTP request/response recording library for elixir, inspired by VCR.
...
- [adobe/elixir-styler](https://github.com/adobe/elixir-styler) ([v1.4.0](https://github.com/adobe/elixir-styler/releases/tag/v1.4.0), 4 weeks ago) - An @elixir-lang code-style enforcer that will just FIFY instead of complaining
