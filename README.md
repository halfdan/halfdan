...
- [adobe/elixir-styler](https://github.com/adobe/elixir-styler) ([v1.9.0](https://github.com/adobe/elixir-styler/releases/tag/v1.9.0), 6 days ago) - An @elixir-lang code-style enforcer that will just FIFY instead of complaining
