...
- [adobe/elixir-styler](https://github.com/adobe/elixir-styler) ([v1.8.0](https://github.com/adobe/elixir-styler/releases/tag/v1.8.0), 4 days ago) - An @elixir-lang code-style enforcer that will just FIFY instead of complaining
