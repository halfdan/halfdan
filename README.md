...
- [adobe/elixir-styler](https://github.com/adobe/elixir-styler) ([v1.4.2](https://github.com/adobe/elixir-styler/releases/tag/v1.4.2), 5 days ago) - An @elixir-lang code-style enforcer that will just FIFY instead of complaining
- [parroty/exvcr](https://github.com/parroty/exvcr) ([v0.17.1](https://github.com/parroty/exvcr/releases/tag/v0.17.1), 1 week ago) - HTTP request/response recording library for elixir, inspired by VCR.
