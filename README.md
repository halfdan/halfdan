...
- [exercism/cli](https://github.com/exercism/cli) ([v3.5.1](https://github.com/exercism/cli/releases/tag/v3.5.1), 6 days ago) - A Go based command line tool for exercism.org.
...
- [How to update multiple records with different values in Ecto.Repo.update_all](https://geekmonkey.org/updating-multiple-records-with-different-values-in-ecto-repo-update_all/) (4 weeks ago)
