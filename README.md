...
- [adobe/elixir-styler](https://github.com/adobe/elixir-styler) - An @elixir-lang code-style enforcer that will just FIFY instead of complaining (today)
...
- [Add OTP26/27 but only run for 1.17/1.18](https://github.com/adobe/elixir-styler/pull/222) on [adobe/elixir-styler](https://github.com/adobe/elixir-styler) (today)
