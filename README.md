...
- [oban-bg/oban](https://github.com/oban-bg/oban) ([v2.20.0](https://github.com/oban-bg/oban/releases/tag/v2.20.0), 2 days ago) - 💎 Robust job processing in Elixir, backed by modern PostgreSQL, SQLite3, and MySQL
- [adobe/elixir-styler](https://github.com/adobe/elixir-styler) ([v1.7.0](https://github.com/adobe/elixir-styler/releases/tag/v1.7.0), 4 days ago) - An @elixir-lang code-style enforcer that will just FIFY instead of complaining
